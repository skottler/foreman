...
%changelog
* Mon Mar 25 2013 Sam Kottler <shk@redhat.com> 1.2.9-1
- Fixed source (shk@redhat.com)

* Mon Mar 25 2013 Sam Kottler <shk@redhat.com> 1.2.8-1
- Removed source (shk@redhat.com)

* Mon Mar 25 2013 Sam Kottler <shk@redhat.com> 1.2.7-1
- Removed version from setup (shk@redhat.com)

* Mon Mar 25 2013 Sam Kottler <shk@redhat.com> 1.2.6-1
- 

* Mon Mar 25 2013 Sam Kottler <shk@redhat.com>
- 

* Mon Mar 25 2013 Sam Kottler <shk@redhat.com> 1.2.5-1
- Got rid of sourceS (shk@redhat.com)

* Mon Mar 25 2013 Sam Kottler <shk@redhat.com> 1.2.4-1
- Fixed source installation (shk@redhat.com)

* Mon Mar 25 2013 Sam Kottler <shk@redhat.com> 1.2.3-1
- Fixed up source handling (shk@redhat.com)
...
* Mon Mar 25 2013 Unknown name 1.2.0-1
- new package built with tito
